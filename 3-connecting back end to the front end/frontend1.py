...
from tkinter import *
import backend
def view_command():#next
    list1.delete(0,END)
    for row in backend.view():#will return list of tuples
        #list1.insert(0,row) #tuple or list or string
        list1.insert(END,row) #tuple or list or string
wind=Tk()
...
b1=Button(wind,text="View all",width=12,command=view_command)#start from here
