#select row from list box 1
from tkinter import *
import backend


def get_selected_row(hamada): #next
    index=list1.curselection()#select the index of pressed line
    print(index)
...
list1.bind('<<ListboxSelect>>',get_selected_row)#start from here will call function get_selected row
