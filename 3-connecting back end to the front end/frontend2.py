...
def search_command():#next
    list1.delete(0,END)
    for row in backend.search(fn.get(),ln.get(),term.get(),gpa.get()):#list of tuples for search result
        list1.insert(END,row)
...
b2=Button(wind,text="Search",width=12,command=search_command)#start from here
