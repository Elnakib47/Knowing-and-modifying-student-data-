...
def update_command():#next
    #backend.update(selected_tuple[0],fn.get(),ln.get(),term.get(),gpa.get())
    backend.update(selected_tuple[0],selected_tuple[1],selected_tuple[2],term.get(),gpa.get())
    view_command()
...
b4=Button(wind,text="Update",width=12,command=update_command)#start
