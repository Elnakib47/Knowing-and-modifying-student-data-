...
def get_selected_row(event):
    global selected_tuple#start from here
...
def delete_command():#last
    backend.delete(selected_tuple[0])#delete selected student who has id = selected_tuple[0] which defind as global
    view_command()
...
b5=Button(wind,text="Delete",width=12,command=delete_command)#next
