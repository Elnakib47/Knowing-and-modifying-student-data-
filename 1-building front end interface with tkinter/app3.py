...
list1=Listbox(wind,height=6,width=35)#new
#list1.grid(row=2)#all list box in side row=2 column=0
list1.grid(row=2,column=0,rowspan=6,columnspan=2)#start from  row=2 column=0
